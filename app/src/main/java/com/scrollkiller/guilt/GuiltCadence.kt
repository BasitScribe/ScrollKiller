...
object GuiltCadence {
     ...
     *
     * ## Why this is 5.5s and not the few seconds the schedule implies
     ...
     * top of the curve that caps the practical rate at ~11 lines a minute, which is already
