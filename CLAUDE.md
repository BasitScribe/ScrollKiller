...
- docs/DECISIONS.md — why-log (append-only ADRs, D1–D78, ~220 KB). **Never open whole — it is the biggest token sink here.** Use PROJECT_MAP's topic→ADR table to get candidate Dn, then read only those
